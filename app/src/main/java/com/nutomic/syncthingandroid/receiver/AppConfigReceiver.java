...
public class AppConfigReceiver extends BroadcastReceiver {
     ...
     */
    private static final String ACTION_START = "gay.rooot.syncthingandroid.action.START";
     ...
     */
    private static final String ACTION_STOP  = "gay.rooot.syncthingandroid.action.STOP";
